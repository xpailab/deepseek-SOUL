...
class ConfigManager:
    ...
    def __init__(self, config_path: str | None = None):
        ...
        if config_path == "":
            self._config_path = self._default_path()
    ...
    def load(self, path: str | None = None) -> SOULConfig:
        ...
        if self._config_path.exists():
            try:
                ...
                # 配置文件损坏或格式不兼容，备份后重建
                backup = self._config_path.with_suffix(".yaml.bak")
    ...
    def update(self, **kwargs: Any) -> None:
        ...
        for key, value in kwargs.items():
            ...
            elif hasattr(self._config, key) and not callable(getattr(self._config, key, None)):
